...
//RSS订阅筐链接
	print("<h1 align=\"center\"><a href=https://zmpt.cc/torrentrss.php?passkey=".$CURUSER['passkey']."&rows=10&paid=0&linktype=dl&inclbookmarked=1 style=\"font-size:15px;text-align:center;color:red;\">https://zmpt.cc/torrentrss.php?passkey=".$CURUSER['passkey']."&rows=10&paid=0&linktype=dl&inclbookmarked=1</a></h1>");
}
