	...
	//print("</td></tr>");
        ...
        <tr>
            <td class="rowhead nowrap" valign="top" align="right">
                <a href="javascript: klappe_news('othercopyi')">
                    <span class="nowrap">
                        <img class="plus" src="pic/trans.gif" alt="Show/Hide" id="picothercopyi" title="显示&nbsp;或&nbsp;隐藏"/> 简介代码
                    </span>
                </a>
            </td>
            <td class="rowfollow" valign="top" align="left">
            <span>展开后点击按钮复制</span>
            <div id='kothercopyi' style="display: none;">
