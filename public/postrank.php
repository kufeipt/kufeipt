...
$res = sql_query("select count(owner) as times, owner from torrents where `approval_status` = 0 and `added` > '2023-10-12 00:00:00' and `added` < '2023-10-22 23:59:59' and `seeders` > 0 and (`category` = 401 or `category` = 402 or `category` = 403 or `category` = 417 or `category` = 418 or `category` = 419 or `category` = 420 or `category` = 421 or `category` = 422) group by owner order by times desc");
