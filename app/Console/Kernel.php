...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('interest:day')->dailyAt("00:30")->withoutOverlapping();
        $schedule->command('interest:month')->monthlyOn(1,"01:00")->withoutOverlapping();
        $schedule->command('start_next_site_free_pool')->everyMinute()->withoutOverlapping();
    }
