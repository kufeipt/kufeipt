...
Route::group(['middleware' => ['auth:nexus', 'locale']], function () {
    ...
    Route::group(['middleware' => ['user']], function () {
        ...
        Route::post('site-free-pool-feed', [\App\Http\Controllers\SiteFreePoolController::class, 'feed']);
        Route::get('all-top-list', [\App\Http\Controllers\SiteFreePoolController::class, 'allTopList']);
        Route::get('latest-list', [\App\Http\Controllers\SiteFreePoolController::class, 'latestList']);
        Route::get('periods-top-list', [\App\Http\Controllers\SiteFreePoolController::class, 'periodsTopList']);
        Route::get('site-free-pool-info', [\App\Http\Controllers\SiteFreePoolController::class, 'info']);
        Route::get('bank-info', [\App\Http\Controllers\BankController::class, 'info']);
        Route::post('bank-operate', [\App\Http\Controllers\BankController::class, 'operate']);
        Route::get('bank-top', [\App\Http\Controllers\BankController::class, 'top']);
        Route::get('bank-account-statement', [\App\Http\Controllers\BankController::class, 'accountStatement']);
    });
});
...
Route::get('iyuu-authvalidate', [\App\Http\Controllers\IyuuAuthController::class, 'validateGetRequest']);
